...
serverless --aws-profile $STELLARTERM_AWS_PROFILE invoke --function ticker --log --data='{ "image_url": "https://assets-cdn.github.com/images/modules/open_graph/github-mark.png", "key": "github.png"}'
