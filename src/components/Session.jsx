...
class Session extends React.Component {
  constructor(props) {
    ...
    this.connectLedger = this.props.d.handlers.connectLedger;
  }
  ...
  render() {
    ...
    if (state === 'out') {
      return <LoginForm setupError={setupError} handler={this.logIn} connectLedger={this.connectLedger}></LoginForm>
