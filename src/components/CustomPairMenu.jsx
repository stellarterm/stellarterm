...
export default class CustomPairMenu extends React.Component {
    ...
    getAssetDropDown(d, assetType) {
        ...
        return (
            <AssetDropDown
                d={d}
                onUpdate={(asset) => { this.stateUpdate(assetType, asset); }}
    ...
    render() {
        ...
        return (
            <div className="island">
                <div className="island__header CustomPairMenu__header">
                  Exchange pair
                </div>
                ...
                <div className="island__sub CustomPairMenu__container">
                    ...
                    <button
                        ...
                        className="CustomPairMenu__button">Start trading</button>
                </div>
            </div>
        );
    }
