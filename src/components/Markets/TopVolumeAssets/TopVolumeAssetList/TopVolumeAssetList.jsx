...
import { niceNumDecimals, formatNumber } from '../../../../lib/helpers/Format';
                        ...
                        <div className="TopVolume_cell">
                            <div className="TopVolume_cell-column">
                                <span className="TopVolume_cell-value">
                                    {formatNumber(Number(closePrice).toFixed(niceNumDecimals(closePrice)))} {baseCode}
                                </span>
                                <span className="TopVolume_cell-value-usd">
                                    {Boolean(priceUSD) && '$'}
                                    {priceUSD ? formatNumber((priceUSD).toFixed(niceNumDecimals(priceUSD))) : '-'}
                                </span>
                            </div>
                        </div>
                        <div className="TopVolume_cell">
                            <div className="TopVolume_cell-column">
                                <span className="TopVolume_cell-value">
                                    {formatNumber(Number(baseVolume).toFixed(niceNumDecimals(baseVolume)))} {baseCode}
                                </span>
                                <span className="TopVolume_cell-value-usd">
                                    {volumeUSD ?
