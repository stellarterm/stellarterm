...
export default class ShutDown extends React.Component {
  render() {
    ...
    <div className="ShutDown__inside s-alert s-alert--warning">
      <h2 className="ShutDown__title">StellarTerm is shutting down on September 31 2018.</h2>
      <br />
      ...
      <p>On September 31 2018, the web app and StellarTerm API will no longer be available. For alternatives, consider checking out <a href="https://stronghold.co/">Stronghold</a>, <a href="https://www.stellarx.com/">stellarx</a>, or the other wallets listed on https://www.stellar.org/lumens/wallets/. StellarTerm is not affiliated with these services.</p>
