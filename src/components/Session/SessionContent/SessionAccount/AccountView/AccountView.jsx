            ...
            <div>
                <div className="so-back islandBack">
                    <div className="island">
                        ...
                        <div className="AccountView_content">
                            By default, your account is only configured to accept <strong>XLM</strong>.{' '}
                            In order to receive other assets, you must <Link to="/account/addTrust/">accept</Link> them using the{' '}
                ...
                <Generic noTopPadding>
                    ...
                    <p>
                        ...
                        Be extremely careful with your secret key and do not share it with anybody.
                    </p>
                </Generic>

                <div className="so-back islandBack" id="reserved" ref={(ref) => { this.$ref = ref; }}>
                    <div className="island">
