        ...
        if (this.state.newKeypair !== null) {
            newKeypairDetails = (
                <div className="LoginPage__generatedNote">
                    <p>
                        <strong>
                            Keep your key secure. This secret key will only be showed to you once. StellarTerm does not
                            save it and will not be able to help you recover it if lost.
                        </strong>
                    </p>
        ...
        const acceptTerms = (
            <label className="s-inputGroup LoginPage__accept" htmlFor="inputAcceptCheckbox">
                ...
                <span className="LoginPage__accept__label">
                    ...
                    , understand the risks associated with cryptocurrencies, and know that StellarTerm does not issue or
                    endorse any asset on the Stellar network.
                </span>
            </label>
        );
                    ...
                    <div className="LoginPage__greenBox">
                        ...
                        <div className="LoginPage__notes">
                            ...
                            <ul>
                                ...
                                <li>
                                    StellarTerm does not save your secret key. It is stored on your browser and will be
                                    deleted once the page is refreshed or exited.
                                </li>
                                <li>
                                ...
                                <li>
                                    ...
                                    warranty. The developer is not responsible for any losses and activities caused by
                                    the application.
                                </li>
                            </ul>
                        </div>
                ...
                <div className="LoginPage__body">
                    <div className="LoginPage__greenBox">
                        <div className="LoginPage__form">
                            ...
                            <p>
                                To get started on using the Stellar network, you must first create a keypair (unless you
                                have a Ledger Nano). The keypair consists of two parts:
                            </p>
                            <ul className="LoginPage__form__list">
                                <li>
                                    <strong>Public key</strong>: The public key is used to identify the account. It is
                                    also known as an account. This public key is used for receiving funds.
                                </li>
                                <li>
                                    <strong>Secret key</strong>: The secret key is used to access your account and make
                                    transactions. Keep this code safe and secure. Anyone with the code will have full
                        ...
                        <div className="LoginPage__notes">
                            ...
                            <p>
                                ...
                                <a href="https://github.com/dchest/tweetnacl-js#random-bytes-generation">
                                    TweetNaCl{"'"}s randomByte function
                                </a>{' '}
                                which, in most browsers, uses getRandomValues from the{' '}
                                <a href="https://w3c.github.io/webcrypto/Overview.html">Web Cryptography API</a>.
                                However, using a secure random number generation does not protect you from a compromised
                                computer. Take great care to make sure your computer is secure and do not run this on a
                                computer you do not trust.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            if (d.session.ledgerConnected) {
                ...
                if (d.session.setupLedgerError) {
                    ...
                    ledgerSetupErrorMessage = (
                        <div className="s-alert s-alert--alert LoginPage__error">
                            Connected to Ledger but returned an error: <br />
                            <strong>{d.session.setupLedgerError}</strong>
                        </div>
                    );
                }
                    ...
                    customPath = (
                        <label className="LoginPage__customPath" htmlFor="bip32Path">
                            ...
                            <input
                                ...
                                value={this.state.bip32Path}
                                onChange={this.handleBip32PathInput}
                                autoFocus
                                onFocus={(e) => {
                    ...
                    <div className="LoginPage__form">
                        ...
                        <form onSubmit={this.proceedWithLedger}>
                            ...
                            <div className="s-inputGroup LoginPage__inputGroup">
                                <input
                                    type="submit"
                                    className="LoginPage__submit inputGroup__item s-button"
                                    value="Sign in with Ledger"
                                    disabled={!this.state.termsAccepted} />
                                {customPath}
                            </div>
                            {ledgerSetupErrorMessage}
                ...
                loginForm = (
                    <div className="LoginPage__form LoginPage__form--simpleMessage">
                        ...
                        <p>
                            Please plug in your Ledger and open the Stellar app. Make sure browser support is set to
                            yes.
                        </p>
                    ...
                    <div className="LoginPage__paddedBox">
                        ...
                        <ol>
                            ...
                            <li>
                                Install the{' '}
                                <a
                                    href="https://www.ledgerwallet.com/apps/manager"
                                    target="_blank"
                                    rel="nofollow noopener noreferrer">
                                    Ledger Manager
                                </a>{' '}
                            ...
                            <li>
                                Inside the app, go to <strong>Settings</strong>, then <strong>Browser support</strong>,
                                then select <strong>yes</strong> and press both buttons.
                            </li>
                        </ol>
                    </div>
                    <div className="LoginPage__paddedBox">
                        ...
                        <ul>
                            ...
                            <li>
                                Choose the BIP32 path of the account you want use: {"44'/148'/n'"} where n is the
                                account index. Or use the default account {"44'/148'/0'"}.
                            </li>
                        </ul>
                    </div>
                </div>
                    ...
                    <div className="island">
                        ...
                        <div className="LoginPage">
                            <div className="LoginPage__sidebar">
                                <a
                                    className={`LoginPage__sidebar__tab${
                                        this.props.urlParts[0] === 'signup' ? ' is-active' : ''
                                    }`}
                                    href="#signup">
                                    New account
                                </a>
                                <a
                                    className={`LoginPage__sidebar__tab${
                                        this.props.urlParts[0] === 'account' ? ' is-active' : ''
                                    }`}
                                    href="#account">
                                    Log in with key
                                </a>
                                <a
                                    className={`LoginPage__sidebar__tab${
                                        this.props.urlParts[0] === 'ledger' ? ' is-active' : ''
                                    }`}
                                    href="#ledger">
                                    <img
