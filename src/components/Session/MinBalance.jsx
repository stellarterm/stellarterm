  ...
  render() {
    ...
    <div className="island__sub">
      <div className="island__sub__division MinBalance__sub">
        ...
        <p>Each entry (asset accepted, offer, signer) increases your minimum balance by 10 XLM. Additionally, StellarTerm enforces a 1XLM of extra minimum balance in an attempt to make sure your account can still make transactions without going below the network minimum balance requirements.</p>
