                        ...
                        signAndSubmitResult.serverResult
                            ...
                            .catch((result) => {
                                ...
                                try {
                                    ...
                                    console.error(event);
                                    errorType = `unknownResponse - ${event.message}`;
                                }
        ...
        if (this.props.d.session.state === 'in') {
            ...
            if (targetBalance) {
                ...
                if (targetAsset.isNative()) {
                    ...
                    youHave = (
                        <div className="OfferMaker__youHave">
                            You have {targetBalance} {targetAsset.getCode()}
                        </div>
                    );
                }
                        ...
                        <tbody>
                            <tr className="OfferMaker__table__row">
                                ...
                                <td className="OfferMaker__table__input">
                                    <label className="OfferMaker__table__input__group" htmlFor="assetPrice">
                                        <input
                                            type="text"
                                            name="assetPrice"
                            ...
                            <tr className="OfferMaker__table__row">
                                ...
                                <td className="OfferMaker__table__input">
                                    <label className="OfferMaker__table__input__group" htmlFor="assetAmount">
                                        <input
                                            type="text"
                                            name="assetAmount"
                                            className="OfferMaker__table__input__input"
                            ...
                            <tr className="OfferMaker__table__row">
                                ...
                                <td className="OfferMaker__table__input">
                                    <label className="OfferMaker__table__input__group" htmlFor="totalAsset">
                                        <input
                                            type="text"
                                            name="totalAsset"
                                            className="OfferMaker__table__input__input"
