...
export default class AssetCard extends React.Component {
  render() {
    ...
    if (!anchor.website || this.props.noLink) {
      ...
      domainLink = (
        <a
          className="AssetCard__federation"
          href={anchor.website}
          target="_blank"
        >
          {anchor.name}
    ...
    if (asset.isNative()) {
      ...
      issuerAccountId = (
        <p className="AssetCard__issuerAccountId">{issuerId}</p>
      );
    }
    assetCardMain = (
      <div className="AssetCard__main">
        <div className="AssetCard__logo">
          <img className="AssetCard__logo__image" src={anchor.logo} />
        </div>
        <div className="AssetCard__content">
          <div className="AssetCard__header">
            <span className="AssetCard__code">
    ...
    if (this.props.children) {
      ...
      return (
        <div className={containerClassName}>
          {assetCardMain}
          <div className="AssetCard__addon">{this.props.children}</div>
        </div>
      );
    }
    return <div className={containerClassName}>{assetCardMain}</div>;
  }
}
