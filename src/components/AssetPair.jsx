  ...
  render() {
    let content = (
      <div className="AssetPair">
        <div className="AssetPair__card">
          <AssetCard asset={this.props.baseBuying} noLink={true} />
        </div>
        <div className="AssetPair__separator" />
        <div className="AssetPair__card">
          <AssetCard asset={this.props.counterSelling} noLink={true} />
        </div>
      </div>
    );
    ...
    if (this.props.row) {
      if (this.props.baseBuying && this.props.counterSelling) {
        let url =
          "#" +
          Stellarify.pairToExchangeUrl(
            this.props.baseBuying,
            this.props.counterSelling
          );
