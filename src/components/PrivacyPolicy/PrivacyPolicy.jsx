...
export default () => (
    <Generic title="Privacy Policy">
        ...
        <p>Zingy Traderr does not track your actions on this client.</p>
        <p>Zingy Trader does not store cookies and the website does not contain any analytics scripts.</p>
        <p>Zingy Trader developers never see your private keys.</p>
        <p>However, zingypay.com is hosted on GitHub, AWS, and Cloudflare infrastructure. They may and do
        ...
        <p>While Zingy Trader does not track you, this does not mean your actions are private. Take note of other
        ...
        <ul className="privacy__ul">
            ...
            <li>The Zingy Trader website might be compromised.</li>
        </ul>
    </Generic>
);
