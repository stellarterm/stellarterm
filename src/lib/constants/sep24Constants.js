...
const textDepositIncomplete = 'Not enough info to initiate the deposit. Please start another transaction';
const textDepositNoMarket = 'No market available to proceed with deposit. Contact anchor for details';
const textDepositTooSmall = 'The transferred amount is less than the minimum for deposit. Contact anchor for details';
const textDepositTooLarge = 'The transferred amount exceeds the maximum for deposit. Contact anchor for details';
const textDepositError = 'Deposit can\'t be completed due to an error. Contact anchor for details';
const textDepositRefunded = 'Deposit refunded by the anchor';
const textDepositExpired = 'Transaction has expired and is no longer updated. Please start another deposit transaction';
...
const textWithdrawPendingUserTransferStart = 'Anchor waiting on you to transfer the funds. Use the \'Withdraw\' button below to initiate the withdrawal';
const textWithdrawPendingUserTransferComplete = 'Your cash is available for in-person pick up. Select the \'More Info\' option on the right to view the details';
const textWithdrawIncomplete = 'Not enough info to initiate the withdrawal. Please start another transaction';
const textWithdrawNoMarket = 'No market available to proceed with withdrawal. Contact anchor for details';
const textWithdrawTooSmall = 'The transferred amount is less than the minimum for withdrawal. Contact anchor for details';
const textWithdrawTooLarge = 'The transferred amount exceeds the maximum for withdrawal. Contact anchor for details';
const textWithdrawError = 'Withdrawal can\'t be completed due to an error. Contact anchor for details';
const textWithdrawRefunded = 'Withdrawal refunded to your account by the anchor';
const textWithdrawExpired = 'Transaction has expired and is no longer updated. Please start another withdrawal transaction';
